...
knitr::kable(interFunction, "html", digits = 2) %>%
...
```{r randomData2, eval = F, out.width = '100%'}
...
```{r ptIntersect2, out.width = '100%' }
# Visualize results table
knitr::kable(res1, "html", digits = 2) %>%
  kable_styling("striped", full_width = F)
...
```{r polyIntersect2, out.width = '100%'}
# Visualize results table
knitr::kable(res2, "html", digits = 2) %>%
  kable_styling("striped", full_width = F)
